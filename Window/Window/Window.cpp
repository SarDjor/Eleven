...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	LPCWSTR(*dllHelloWorld)();
	dllHelloWorld = (LPCWSTR(*)())GetProcAddress(hi, "LetterList");
	LPCWSTR mess = dllHelloWorld();  //Char to LPCWSTR
	
	
		

	Foo a;
	//LPCWSTR mesforstat = CharToLPWSTR(a.vivod());
	...
	case WM_LBUTTONDOWN:
		MessageBox(hWnd, a.vivod() , TEXT("No matter"), IDOK | IDCANCEL);
		break;
	case WM_RBUTTONDOWN:
		MessageBox(hWnd, mess, TEXT("No matter"), IDOK | IDCANCEL);
		FreeLibrary(hi);
		break;
	case WM_COMMAND:
		wmId    = LOWORD(wParam);
